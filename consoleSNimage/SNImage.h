...
{   private:
	...
	public:
		...
		void AfficherImageTexte(int niveau);
		void AfficherImageTexte4Seuils();
		void AfficherImageTexte10caracteres(char caracteres[11]);
		...
		void DessinerCroixEtCoordonnees(Coordonnee coord,int tailleCroix,int epCroix,int tailleTexte,int epTexte,Pixel coul,bool droite);
